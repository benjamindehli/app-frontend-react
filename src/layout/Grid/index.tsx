...
import { GridSummary2Component } from 'src/layout/Grid/GridSummary2Component';
...
export class Grid extends GridDef {
  ...
  renderSummary2(summaryNode: LayoutNode<'Grid'>): JSX.Element | null {
    return <GridSummary2Component summaryNode={summaryNode} />;
  }
